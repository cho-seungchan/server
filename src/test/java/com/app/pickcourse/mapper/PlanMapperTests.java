...
//    계획 추가
    ...
    public void testInsert() {
        ...
        planVO.setPlanStartAddress("주소2");
        planVO.setPlanFileName("파일이름2");
        planVO.setPlanFileSize("파일크기2");
        planVO.setPlanFilePath("파일경로2");
        planVO.setMemberId(member.getId());
        planVO.setCourseId(readCourse.getId());
        planVO.setPlanContent("내용2");
